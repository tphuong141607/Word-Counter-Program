...
The program shall count all characters, words and lines of the input text file. After doing all the calculations, the program stores the results into another text file with the name provided by the user. This word couter was created on May 9, 2019 using C language. It behaves exactly like the word couting service in this [website](https://wordcounter.net/character-count)
